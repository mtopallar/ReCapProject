...
namespace Business.Concrete
{
    public class UserManager : IUserService
    {
        ...
        {
            return new SuccessDataResult<User>(_userDal.Get(u=>u.Email==email),Messages.GetUserByIdSuccessfully);
        }

        public IDataResult<List<OperationClaim>> GetClaims(User user)
        {
            return new SuccessDataResult<List<OperationClaim>>(_userDal.GetClaims(user),Messages.GetUserClaimsSuccessfully);
        }
